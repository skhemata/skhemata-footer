...
const SkhemataFooterStyle = i`
  html {
    --skhemata-footer-text: Arial, Helvetica, sans-serif;
    --skhemata-footer-background: rgb(57, 68, 75);
  }
...
class SkhemataFooter extends SkhemataBase {
  static get scopedElements() {
    return {
      'fa-icon': D
    };
  ...
  static get styles() {
    return [...super.styles, SkhemataFooterStyle, i`
        footer {
          background: var(
  ...
  checkMedia(media) {
    ...
    switch (media.type) {
      case 'twitter':
        template = T`<a class="skhemata-social-media" href="${media.link}"
        ...
        <div class="container">
          <div class="columns footer-top">
            ...
            <div class="column has-text-centered-mobile">
              ...
              >
                ${this.configData.menus.map((menu, index) => index < 4 ? T`<div
                      ...
                      >
                        ...
                        <ul class="footer-links has-text-centered-mobile">
                          ${menu.submenu.map((submenu, subIndex) => subIndex < 5 ? T`<a
          ...
          <div class="columns custom-footer-bottom is-vcentered has-text-grey">
            ...
            >
              <div class="custom-footer-social">
                <div class="custom-footer-social">
                  ${this.configData.socialMedia.map(media => T`${this.checkMedia(media)}`)}
                </div>
              </div>
            </div>
          </div>
...
__decorate([e$3({
  type: Object,
  attribute: 'config-data'
})], SkhemataFooter.prototype, "configData", void 0);
